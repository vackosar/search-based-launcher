...
public class MainActivity extends Activity {
    ...
    List<App> pkgExtra = new ArrayList<App>();
    List<App> pkgHide = new ArrayList<App>();
    List<App> pkgRecent = new ArrayList<App>();
    ...
    private final BroadcastReceiver mPkgApplicationsReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            loadApps();
            pkgRecent.retainAll(pkg);
            pkgExtra.retainAll(pkg);
            pkgHide.retainAll(pkg);
